...
function drawRightSlidePanel() {
    if (rightSlidePanelToken >= 0) {
        ...
        sideContext.fillText("ZiyaIzaanAnam", panelLeftSide + sideCanvas.width / 2, baseUnitSize * 14);
...
function drawInstructions() {
    ...
    context.fillText("Tetris Game", canvas.width / 2, baseUnitSize * 2);
...
function drawStats() {
    ...
    sideContext.textAlign = "center";
    sideContext.fillText(" ", sideCanvas.width / 2, baseUnitSize * 18);
    sideContext.font = (baseUnitSize / 2) + "px Monaco, monospace";
...
function drawLeaderboard() {
    if (leaderboard != 0) {
        ...
        context.textAlign = "center";
        context.fillText("...", (canvas.width / 2), baseUnitSize * 10 * 60 / gameOverSlideInToken);
    }
}
